...
/*   Updated: 2025/06/13 00:13:42 by mzutter          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../headers/lexer.h"

size_t  next_chunk_end(const char *s, size_t start, bool (*is_sep)(char))
{
    size_t  i;
...
char    **chunk_handl(char **res, size_t *count_ptr, size_t *capacity_ptr, char *chunk)
{
    char    **new_res;
    size_t  count;
    size_t  capacity;
